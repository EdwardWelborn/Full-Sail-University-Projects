            ...
            */
            while (boolShowCaseRunning)
            {
                ...
                switch (input)
                {
                    ...
                    case "alphabetically":
                        {
                            ListData(conn, "SELECT * FROM SampleRestaurantDatabase.RestaurantProfiles order by RestaurantName ASC;");
                        }
                        break;
                    case "2":
                    ...
                    case "reverse":
                        {
                            ListData(conn, "SELECT * FROM SampleRestaurantDatabase.RestaurantProfiles order by RestaurantName DESC;");
                        }
                        break;
                    case "3":
                    ...
                    case "best":
                        {
                            ListData(conn, "SELECT * FROM SampleRestaurantDatabase.RestaurantProfiles order by OverallRating ASC;");
                        }
                        break;
                    case "4":
                    ...
                    case "worst":
                        {
                            ListData(conn, "SELECT * FROM SampleRestaurantDatabase.RestaurantProfiles order by OverallRating DESC;");
                        }
                        break;
                    case "5":
            ...
            */
            ...
            while (boolSubMenuRunning)
            {
                ...
                switch (input)
                {
                    ...
                    case "4 star":
                        {
                            ListData(conn, "SELECT * FROM SampleRestaurantDatabase.RestaurantProfiles where OverallRating >= 4 Order By OverallRating Desc;");
                        }
                        break;
                    case "3":
                    ...
                    case "3 star":
                        {
                            ListData(conn, "SELECT * FROM SampleRestaurantDatabase.RestaurantProfiles where OverallRating >= 3 Order By OverallRating Desc;");
                        }
                        break;
                    case "4":
                    case "show the worst":
                    case "1 star":
                        {
                            ListData(conn, "SELECT * FROM SampleRestaurantDatabase.RestaurantProfiles where OverallRating <= 1 Order By OverallRating Desc;");
                        }
                        break;
                    case "5":
                    case "show unrated":
                    case "unrated":
                        {
                            ListData(conn, "SELECT * FROM RestaurantProfiles WHERE OverallRating is null Order By RestaurantName;");
                        }
                        break;
                    case "6":
                    case "r":
...
//                int ID = 0;
                ...
                while (rdr.Read())
                {
                    ...
                    newList = (RestaurantName + "~" + Address + "~" + Phone + "~" + HoursOfOperation + "~" + Price +
                              ...
                              ServiceRating + "~" + AmbienceRating + "~" + newOverAllRating + "~" + OverAllPossibleRating +
                              "~" + "!end");
        ...
        public static void ListData(MySqlConnection conn, string SQLstatement)
        {
            ...
            SetWindowPos(MyConsole, 0, xpos, ypos, 0, 0, SWP_NOSIZE);
            Console.Clear();
            Console.WriteLine("Restaurant Name                                   Cuisine                            Rating");
            Console.WriteLine("-------------------------------------------------------------------------------------------");
