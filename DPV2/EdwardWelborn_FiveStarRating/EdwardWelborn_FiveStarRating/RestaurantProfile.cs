...
namespace EdwardWelborn_FiveStarRating
{
    class RestaurantProfile
    {
        ...
        public RestaurantProfile(int ID, string RestaurantName, string Address, string Phone, string HoursOfOperation, string Price, string USACityLocation, string Cuisine, decimal FoodRating, 
        ...
        {
            list.Sort((p1, p2) => string.Compare(p1, p2, true));
        }
    }
}
/*
